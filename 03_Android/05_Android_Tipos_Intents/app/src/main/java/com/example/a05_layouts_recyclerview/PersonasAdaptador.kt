    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            accionBoton.setOnClickListener {
                ...
                contexto.cambiatNombreTextView("WOW!!")

                // Cambiar una lista por completo
                val nuevasPersonas = arrayListOf<Persona>()
                nuevasPersonas.add(Persona("Daniel","1756489652"))
                nuevasPersonas.add(Persona("Javier","1755469652"))
                nuevasPersonas.add(Persona("Maria","1716689650"))
